...
<script type="text/javascript">
swfobject.embedSWF( "<?php echo PRLI_URL; ?>/pro/includes/version-2-kvasir/open-flash-chart.swf", "clicks_chart", "100%", "300", "9.0.0", "expressInstall.swf", {"data-file":"<?php echo urlencode(PRLIPRO_VIEWS_URL."/prli-reports/split-test-chart-data.php?sdate=$start_timestamp&edate=$end_timestamp&id=$id"); ?>"} );
