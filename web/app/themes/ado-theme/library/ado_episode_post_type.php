...
function ado_episode() { 
  ...
  register_post_type( 'ado_episode', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
    ...
    array( 'labels' => array(
      'name' => __( 'Episodes', 'bonestheme' ), /* This is the Title of the Group */
      'singular_name' => __( 'Episode', 'bonestheme' ), /* This is the individual type */
      'all_items' => __( 'All Episodes', 'bonestheme' ), /* the all items menu item */
      'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
      'add_new_item' => __( 'Add New Episode', 'bonestheme' ), /* Add New Display Title */
      'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
      'edit_item' => __( 'Edit Episodes', 'bonestheme' ), /* Edit Display Title */
      'new_item' => __( 'New Episode', 'bonestheme' ), /* New Display Title */
      'view_item' => __( 'View Episode', 'bonestheme' ), /* View Display Title */
      'search_items' => __( 'Search Episode', 'bonestheme' ), /* Search Custom Type Title */ 
      'not_found' =>  __( 'No episodes found', 'bonestheme' ), /* This displays if there are no entries yet */ 
      'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
      'parent_item_colon' => ''
      ), /* end of arrays */
      'description' => __( 'An episode of the ADO Podcast', 'bonestheme' ), /* Custom Type Description */
      'public' => true,
  ...
  */
  ...
  register_taxonomy( 'custom_cat', 
    array('ado_episode'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
